...
INSERT INTO `attributesOrderProduct` VALUES (97,1),(97,3),(98,1),(98,3),(98,4),(99,1),(99,3);
...
INSERT INTO `orderProducts` VALUES (87,81,86,'',1),(88,81,17,'',1),(89,82,29,'',3),(90,85,42,'',3),(91,87,29,'',11),(92,94,16,'',1),(93,96,10,'',4),(94,98,21,'',1),(95,99,18,'',1),(96,100,73,'Com gelo',1),(97,100,29,'',2),(98,102,29,'obs',2),(99,2,29,'',2);
...
CREATE TABLE `productattributes` (
  ...
  KEY `attributeId` (`attributeId`),
  CONSTRAINT `productattributes_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `products` (`id`),
  CONSTRAINT `productattributes_ibfk_2` FOREIGN KEY (`attributeId`) REFERENCES `attributes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (1,'Salgado',11,0,1.5,NULL),(2,'Creme do dia',11,0,3,NULL),(3,'Camarão Panado',11,0,9.5,'Panko, camarão, sweet chili'),(4,'Nigiri de pato fumado (4un)',11,0,7.5,'Arroz sushi, pato fumado com ervas secas, molho teriyaki de laranja'),(5,'Ovos Sauvage',11,0,8,'Ovo panado, lascas de batata, crumble de farinheira, molho aveludado de ervas'),(6,'Brás de farinheira',11,0,8.5,'Batata palha, ovo, farinheira, azeitonas, salsa'),(7,'Prego de lombo de atum braseado',11,0,13,'Pão brioche, atum fresco, compota de cebola roxa, chips de batata doce'),(8,'Ravioli al pesto ',9,0,15,'Recheado com bovino, espinafres, queijo parmesão e molho pesto'),(9,'Pad Thai Vegetais',9,0,13.5,'Noodles de arroz, ovo, soja, amendoim, cebolinho, malagueta, tamarindo, legumes'),(10,'Pad Thai Frango',9,0,14.5,'Noodles de arroz, ovo, soja, amendoim, cebolinho, malagueta, tamarindo, legumes'),(11,'Pad Thai Camarão ',9,0,15.5,'Noodles de arroz, ovo, soja, amendoim, cebolinho, malagueta, tamarindo, legumes'),(12,'Risotto de cogumelos',9,0,14,'Arroz arbóreo, ragu de cogumelos, azeite trufado e queijo parmesão'),(13,'Risotto de pato ',9,0,15,'Arroz arbóreo, pato desfiado, chouriço crocante, queijo parmesão'),(14,'Spaghetti aioli ',9,0,13.5,'Tomate seco, alcaparras, salsa, picante, alho'),(15,'Salada de quinoa ',13,0,12,'Legumes salteados, cebola roxa, pesto de salsa e lascas de queijo parmesão'),(16,'Nasigoreng de legumes ',13,0,13.5,'Arroz frito, legumes, ovo, molho de soja'),(17,'Atum fresco ',14,0,15.5,'Tataki, legumes salteados, consomé de cogumelos, maionese de wasabi e salada wakamé'),(18,'Caril de camarão ',14,0,15,'Camarão, caril, arroz basmati'),(19,'Feijoada de choco com arroz basmati ',14,0,14,'Feijão branco, choco, enchidos, arroz basmati'),(20,'Pasteis de bacalhau ',14,0,13,'Pasteis de bacalhau, mayo de pickles, arroz tomate'),(21,'Bochechas de Porco ',15,0,15.5,'Bochechas de porco estufadas, puré de ervilhas, crispy bacon, ovo escalfado'),(22,'Empada de ragu de novilho ',15,0,15,'Com o molho do estufado, chips de batata doce, grelos salteados'),(23,'Chamuças de coelho ',15,0,14,'Com mayo de açafrão, arroz de ervilha'),(24,'Secretos à lagareiro',15,0,14.5,'Com batata a murro, grelos salteados'),(25,'Mousse de chocolate negro',7,0,5,'Flôr de sal e azeite'),(26,'Tarte de lima',7,0,5,'Caramelizada'),(27,'Panna cotta',7,0,5,'Chocolate branco, culi de frutos vermelhos'),(28,'Fruta da época',7,0,3.5,NULL),(29,'Astronauta Moscatel Galego (DOURO)',16,0,20,NULL),(30,'Ribeiro Santo Colheita (DÃO)',16,0,17,NULL),(31,'Ribeiro Santo Colheita COPO',16,0,4.5,NULL),(32,'5ª Lagar Novo (LISBOA)',16,0,20,NULL),(33,'Maria Mora (ALENTEJO)',16,0,18,NULL),(34,'Maria Mora (ALENTEJO) COPO',16,0,5,NULL),(35,'Astronauta Vinhas Velhas (DOURO)',17,0,20,NULL),(36,'Astronauta Vinhas Velhas (DOURO) COPO',17,0,5,NULL),(37,'Ribeiro Santo Colheita (DÃO)',17,0,17,NULL),(38,'Ribeiro Santo Colheita (DÃO) COPO',17,0,4.5,NULL),(39,'Autocarro 27 (SETUBAL) ',17,0,18,NULL),(40,'Maria Mora (ALENTEJO)',17,0,18,NULL),(41,'Maria Mora (ALENTEJO) COPO',17,0,5,NULL),(42,'Soalheiro Allo',18,0,17,NULL),(43,'Soalheiro Allo COPO ',18,0,4.5,NULL),(44,'Ribeiro Santo (DÃO)',19,0,17,NULL),(45,'Ribeiro Santo (DÃO) COPO',19,0,4.5,NULL),(46,'Luís Pato Blanc des Blancs',20,0,18,NULL),(47,'Luís Pato Blanc des Blancs COPO',20,0,5,NULL),(48,'Moet Chandon Brut Imperial',35,0,65,NULL),(49,'Viper Eyes',21,0,8.5,'Aperitivo: Martini Fiero, Martini Ambrato, sumo de limão, hibiscus, água Castello'),(50,'OIE ',21,0,9.5,'Aperitivo: Grey Goose, St. Germain, sumo de limão, água Castello'),(51,'Mico',21,0,9.5,'Refeição: Bacardi 4, abacaxi, sumo de limão, hortelã, água Castello'),(52,'Mowgli ',21,0,9.5,'Refeição: Eristoff, morango, sumo de limão, hortelã, ginger beer'),(53,'Weasel',21,0,9.5,'Digestivo: Aberfeldy, agave, bitter de laranja, bitter de chocolate'),(54,'Eristoff',22,0,6,NULL),(55,'Grey Goose',22,0,8.5,NULL),(56,'Martini Rubino',23,0,6,NULL),(57,'Martini Ambrato',23,0,6,NULL),(58,'Martini Fiero',23,0,6,NULL),(59,'Carcavelos Villa Oeiras',24,0,6,NULL),(60,'Porto Andresen Tawny',24,0,5,NULL),(61,'Porto Andresen White',24,0,5,NULL),(62,'Licor Beirão',24,0,4,NULL),(63,'Amarguinha',24,0,4,NULL),(64,'CRF',24,0,5,NULL),(65,'Bombay Dry',25,0,8,NULL),(66,'Star of Bombay',25,0,10,NULL),(67,'Hendrick´s ',25,0,9,NULL),(68,'Citadelle',25,0,9,NULL),(69,'Monkey 47 ',25,0,12,NULL),(70,'Monkey 47 Sloe Gin',25,0,12,NULL),(71,'Dewar´s ',26,0,6,NULL),(72,'Bushmills',26,0,8,NULL),(73,'Jameson ',26,0,7,NULL),(74,'Nikka from the barrel ',26,0,12,NULL),(75,'Aberfeldy ',26,0,12,NULL),(76,'Bacardi Carta Blanca ',27,0,6,NULL),(77,'Bacardi 4 ',27,0,7,NULL),(78,'Diplomatico Reserva Exclusivo ',27,0,12,NULL),(79,'Heineken ',28,0,2,NULL),(80,'Heineken Pint ',28,0,2,NULL),(81,'Heineken Panaché ',28,0,4,NULL),(82,'Heineken 0.0 ',28,0,2,NULL),(83,'Heineken 0',33,28,0,'2.5'),(84,'Bandida do Pomar ',28,0,2.5,NULL),(85,'Espumante (2L) ',29,0,28,'Espumante, vodka Eristoff, rum Bacardi, lima, puré de framboesa, hortelão, sprite'),(86,'Rosé (2L) ',29,0,25,'Vinho rosé, vodka Eristoff, rum Bacardi, puré de framboesa, hortelã, sprite'),(87,'Branca (2L) ',29,0,22,'Vinho branco, vodka Eristoff, rum Bacardi, laranja, limão, maçã, hortelã, frutos vermelhos, sumo maracujá, sprite'),(88,'Tinta (2L) ',29,0,22,'Vinho tinto, vodka Eristoff, rum Bacardi, laranja, limão, maçã, hortelã, canela, sprite'),(89,'Coca-cola ',30,0,2.5,NULL),(90,'Coca-cola zero ',30,0,2.5,NULL),(91,'Sprite copo ',30,0,2,NULL),(92,'Nestea Limão/Pêssego ',30,0,2,NULL),(93,'Ginge Ale Fever-Tree ',30,0,3.5,NULL),(94,'Ginger-Beer Fever-Tree ',30,0,3.5,NULL),(95,'Sumo de laranja ',31,0,3.5,NULL),(96,'Limonada ',31,0,3.5,NULL),(97,'Sumo Sauvage',31,0,3.5,NULL),(98,'Água Luso 25cl ',32,0,1.5,NULL),(99,'Água Luso 50cl ',32,0,2.8,NULL),(100,'Água Tónica Fever-Tree ',32,0,3.5,NULL),(101,'Água Luso Gás ',32,0,2.2,NULL),(102,'Água Castello ',32,0,2.2,NULL),(103,'Café ',33,0,1,NULL),(104,'Descafeinado',33,0,1,NULL),(105,'Café Duplo',33,0,2,NULL),(106,'Cappuccino',33,0,2.5,NULL),(107,'Carioca de Limão',33,0,1.5,NULL),(108,'Preto ',34,0,2.2,NULL),(109,'Verde ',34,0,2.2,NULL),(110,'Tília ',34,0,2.2,NULL),(111,'Camomila',34,0,2.2,NULL),(112,'Menta ',34,0,2.2,NULL),(113,'Cidreira ',34,0,2.2,NULL),(114,'Frutos Vermelhos',34,0,2.2,NULL);
...
INSERT INTO `systemproperties` VALUES (1,'Sauvage','/static/images/Logo Sauvage.jpeg',123456789,'Rua da Nossa Senhora das Azinhas n9','1000-690','+351913967083');
...
-- Dump completed on 2020-05-17 23:36:20
